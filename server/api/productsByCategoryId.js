...
export default defineEventHandler(async (_) => {
    ...
    try {
        ...
        if (subCategoryIds.length === 0) {
            return { success: false, error: 'No SubCategorii found for the given Categorii id' };
        }


        // Step 2: Get SubSubCategorii ids based on SubCategorii ids
        ...
        if (subSubCategoryIds.length === 0) {
            return { success: false, error: 'No SubSubCategorii found for the given SubCategorii ids' };
        }
